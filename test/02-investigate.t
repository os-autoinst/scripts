...
curl() {
    if [[ "$@" =~ investigation_ajax ]]; then
        echo -n '{"diff_packages_to_last_good": "Diff of packages not available",
              "diff_sut_packages_to_last_good": "Diff of packages not available",
              "diff_to_last_good": "",
             "first_bad": {},
             "last_good": {
               "link": "/tests/000",
                ...
                "test_diff_stat": "",
                "test_log": "",
                "testgiturl": "https://github.com/os-autoinst/os-autoinst-distri-opensuse/commit/"}'
        echo -n $'\n'
        echo -n 200
    else
        echo -n 200
